...
void test_validate_my_username()
{
     ...
     */
    const char* nameExpected = my_username();
    const char* nameActual = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(nameExpected, nameActual, "UserName doesn't match");
}
